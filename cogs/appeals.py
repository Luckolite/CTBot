...
class Appeals(commands.Cog):
    ...
    async def appeal(self, ctx, *, appeal):
        ...
        if user_id in self.blacklist:
            ...
            cooldown = self.blacklist[user_id]['cooldown']      # cooldown until can appeal again
            if cooldown:
                cd = cooldown - time()
                if cd > 0:
            ...
            e = discord.Embed(color=utils.theme_color(ctx.bot), description="Appeals need to contain why you are "
