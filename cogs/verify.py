...
class Verify(commands.Cog):
    ...
    async def on_member_join(self, ctx, member):
        ...
        key = ''.join([random.choice(strong.ascii_letters +
                                     string.digits) for n in xrange(32)])
        await member.send("Hello! Thank you for joining! This server is "
        ...
        while True:
            ...
            if str(msg) is key:
                ...
                member.send("Sorry, you have failed the CAPTCHA. "
            ...
            try:
                ...
                await member.send("An error occured, please contact "
